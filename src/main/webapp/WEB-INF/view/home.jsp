		...
		<div class="row">
			<div class="col-md-4 stretch-card grid-margin">
				<div class="card bg-gradient-danger card-img-holder text-white">
					<div class="card-body">
						<img src="<c:url value="/resources/images/dashboard/circle.svg"/>"
						...
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									<tr>
										<td><img
											src="<c:url value="/resources/images/faces/face1.jpg"/>"
											class="mr-2" alt="image"> Khả Nhật</td>
									...
									<tr>
										<td><img
											src="<c:url value="/resources/images/faces/face2.jpg"/>"
											class="mr-2" alt="image"> Quang Đại</td>
									...
									<tr>
										<td><img
											src="<c:url value="/resources/images/faces/face3.jpg"/>"
											class="mr-2" alt="image"> Đại Nghĩa</td>
									...
									<tr>
										<td><img
											src="<c:url value="/resources/images/faces/face4.jpg"/>"
											class="mr-2" alt="image"> Quang Minh</td>
