					...
					<div class="card-body">
						...
						<div class="content-header-right ">
							<div role="group" aria-label="Button group with nested dropdown"
								...
								<a href="<c:url value = "add_form"/>" class="btn btn-info small-button" ><span
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination">
								...
								<c:if test="${indexPage > 1}">
									<li class="page-item"><a href="/vatlieu/list?page=1"
								...
								<c:if test="${indexPage > 1}">
									<li class="page-item"><a
										href="/vatlieu/list?page=${indexPage-1}" class="page-link">${indexPage-1}</a></li>
								</c:if>


								<li class="page-item"><a
									href="/vatlieu/list?page=${indexPage}" class="page-link">${indexPage}</a></li>
								...
								<c:if test="${indexPage < allPage}">
									<li class="page-item"><a
										href="/vatlieu/list?page=${allPage}" class="page-link">Last</a></li>
								</c:if>
								...
								<tbody>
									<c:forEach var="emp" items="${list}">
										<tr>
											...
											<td>${emp.soLuong}</td>
											<s:eval
												expression="T(com.ffse1704.common.Utils).formatMoney(emp.donGia)"
												var="donGia" />
											<td>${donGia}</td>
											<s:eval
											...
											<td><a href="/vatlieu/edit/${emp.maCongViec}"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-header">
												<h4 class="modal-title">Xóa Vật Liệu</h4>
											...
											<form id="command" class="forms-sample"
												action="/vatlieu/delete" method="post">
